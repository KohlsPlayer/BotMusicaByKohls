...
prefix: "f!", //<- Change whatever with your prefix//
mobile: true,
connectedBots: true
})
...
bot.variables({
  ...
  pause: "⏸️ Pausado.",
  resume: "▶️ Retomada!",
  skip: "⏩ Pulada!",  //Available {song}//
  stop: "⏹ Parou.",  
  remove: "Removed song on {d-amount}.", //Available {d-amount}//

  clearsong: "✅ Fila limpa. de **{amount} musica** para **0**", //Available {amount}//
  ...
  channelstatus: "927699643503116288", //Change to your channel id, to send message when the bot restart.// 
